...
def main():
    ...
    # 5. Callbacks
    application.add_handler(CallbackQueryHandler(division_callback_dispatcher, pattern=r"^(div|dist|dist_p|upz|back|ldiv|ldist|ldist_p|lupz|lback|lref|hdiv|hdist|hdist_p|hupz|hback|href|ddiv|ddist|ddist_p|dupz|dback|dref|noop)($|:)"))
