...
async def handle_text_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Fetch weather for the identified or default city
    cities = await search_city(target_city)
    if not cities:
        await update.message.reply_text(f"❌ '{target_city}' শহর খুঁজে পাওয়া যায়নি।")
        return
    ...
    # Respond contextually based on intent
    if intent == "rain":
    ...
    # Default / General Weather: display full rich weather card!
